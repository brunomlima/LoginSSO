...
export class IconsService
{
    ...
    constructor()
    {
        ...
        // Register individual Google and Microsoft icons
        matIconRegistry.addSvgIcon('google', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/google.svg'));
        matIconRegistry.addSvgIcon('microsoft', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/microsoft.svg'));
    }
